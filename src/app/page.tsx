    ...
    <div className="min-h-screen bg-[#0A0F0D] selection:bg-[#E8B547]/30">
      ...
      <section ref={ref} className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 pt-10 sm:pt-14 pb-8">
          <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-8 lg:gap-6 items-center">
            <div>
              ...
              <div className="mt-7 flex items-center gap-3">
                <div className="flex items-center gap-2 text-xs"><span className="px-2.5 py-1 rounded-full bg-[#E8B547] text-[#0A0F0D] font-black">Early access</span><span className="text-[#EFE9DA]/60">Be among first shops • 90 days free • No fake reviews</span></div>
              </div>
            </div>
          ...
          <div className="mt-8 grid grid-cols-3 gap-2 sm:gap-3 max-w-3xl">
            ...
            <div className="rounded-xl bg-[#141C18] border border-[#263329] px-3 py-3 flex items-center gap-3"><span className="w-8 h-8 rounded-lg bg-emerald-500/15 text-emerald-400 flex items-center justify-center">⚡</span><div><div className="text-sm font-bold text-[#EFE9DA]">Live ETA</div><div className="text-xs text-[#EFE9DA]/50">Customer sees wait</div></div></div>
            <div className="rounded-xl bg-[#141C18] border border-[#263329] px-3 py-3 flex items-center gap-3"><span className="w-8 h-8 rounded-lg bg-[#E8B547]/15 text-[#E8B547] flex items-center justify-center">⊕</span><div><div className="text-sm font-bold text-[#EFE9DA]">No app needed</div><div className="text-xs text-[#EFE9DA]/50">QR → web page</div></div></div>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 py-10 sm:py-14">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[1.1fr_0.9fr] gap-6 items-center">
          <div className="rounded-[20px] bg-[#111815] border border-[#263329] p-6"><h3 className="text-xl font-black text-[#EFE9DA]">Example math — see if it fits you</h3><p className="text-sm text-[#EFE9DA]/60 mt-1">Illustrative only — not a guarantee. Replace with your numbers.</p><div className="mt-5 grid grid-cols-3 gap-3"><div className="rounded-xl bg-[#0A0F0D] border border-[#263329] p-4 text-center"><div className="text-2xl font-black text-[#E8B547]">₹1,200</div><div className="text-xs text-[#EFE9DA]/50">Example lost / mo (2 walk-aways)</div></div><div className="rounded-xl bg-[#0A0F0D] border border-[#263329] p-4 text-center"><div className="text-2xl font-black text-white">₹799</div><div className="text-xs text-[#EFE9DA]/50">Pro plan / mo</div></div><div className="rounded-xl bg-[#E8B547] p-4 text-center"><div className="text-2xl font-black text-[#0A0F0D]">+₹401</div><div className="text-xs text-[#0A0F0D]/70">Net in this example</div></div></div><div className="mt-4 rounded-xl bg-[#EFE9DA]/10 border border-[#EFE9DA]/20 px-4 py-3 text-sm text-[#EFE9DA]/70">Your mileage varies — try free for 90 days and measure walk-aways yourself.</div></div>
          <div className="rounded-[20px] bg-[#1E2528] border border-[#263329] p-6"><h4 className="font-bold text-[#EFE9DA]">Early access — no fake reviews</h4><p className="text-sm text-[#EFE9DA]/60 mt-1">We have 0 customers yet. Be a founding shop — help shape the product and get 90 days free.</p><div className="mt-4 rounded-xl bg-[#0A0F0D] border border-dashed border-[#263329] p-4"><div className="text-sm text-[#EFE9DA]/50">Real stories will appear here after first shops go live. Your story could be first.</div><div className="text-xs text-[#E8B547] mt-2">→ Founding shops get white-glove onboarding + direct founder support</div></div><div className="mt-3 text-xs text-[#EFE9DA]/30">Honest from day 1 — we don’t fabricate testimonials.</div></div>
        </div>
      </section>
